...
if [ "$1" = "graalvm" ];
then
    sh ./docker-stats.sh now conference_service_micronaut
else
    sh ./docker-stats.sh now conference_service_micronaut_1
fi
...
if [ "$1" = "graalvm" ];
then
    docker stop conference_service_micronaut
else
    docker stop conference_service_micronaut_1
fi
